...
mod tests {
    ...
    use brainease_lexer::syntax::{CellOrChar, CellOrPointer, GotoBy, GotoDirection, Instruction};
    ...
    fn parse_bf() {
        ...
        let parsed_instructions = brainease_lexer::parser::parse_file(&stringified_ins.join("\n"));
